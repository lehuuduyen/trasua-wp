...
class THEMECOMPLETE_EPO_Display {
	...
	private function print_price_fields( $product_id = 0, $form_prefix = '', $is_from_shortcode = false ) {
		...
		$tm_epo_show_options_total = ( empty( THEMECOMPLETE_EPO()->tm_meta_cpf['override_show_options_total'] ) ) ? THEMECOMPLETE_EPO_DATA_STORE()->get( 'tm_epo_show_options_total' ) : THEMECOMPLETE_EPO()->tm_meta_cpf['override_final_total_box'];
